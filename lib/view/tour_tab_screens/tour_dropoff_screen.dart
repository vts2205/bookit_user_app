...
import 'package:bookit_user_app/view/tour_tab_screens/tour_package_screen.dart';
import 'package:bookit_user_app/widgets/appbar_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class TourDropOffScreen extends StatelessWidget {
  const TourDropOffScreen({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        ListTile(
          ...
          onTap: () {
            Get.to(const TourPackageScreen());
          },
        ),
        const Divider(),
        ListTile(
