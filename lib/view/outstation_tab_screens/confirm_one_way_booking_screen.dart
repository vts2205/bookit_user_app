...
class ConfirmOneWayBookingScreen extends StatefulWidget {
  const ConfirmOneWayBookingScreen({Key? key}) : super(key: key);

  @override
  State<ConfirmOneWayBookingScreen> createState() =>
      _ConfirmOneWayBookingScreenState();
}

class _ConfirmOneWayBookingScreenState
    extends State<ConfirmOneWayBookingScreen> {
  int selectedValue = 0;
  @override
        ...
        child: ListView(
          children: [
            ...
            Column(
              children: const [
                Text(
                  'One way trip of about 100kms, 1 hrs 30 mins',
                  style: TextStyle(fontSize: 17),
                ),
                SizedBox(
                  height: 10,
